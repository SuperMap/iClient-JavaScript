...
window.examplesResources = {
    ...
    "footer": {
        ...
        "copyright": "Copyright © 2000-2019 SuperMap Software Co., Ltd. All rights reserved"
    },
    "editor": {
        "expand": " Expand",
        "source": " Source",
    ...
    "resources": {
        ...
        "title_componentsChart_Vue": 'Chart Widget(Vue）',
        "title_componentsChart_Vue(pie)":'Pie Chart Widget(Vue）',
        "title_componentsChart_Vue(radar)":'Radar Chart Widget(Vue）',
        "title_componentsChart_Vue(gauge)":'Gauge Chart Widget(Vue）',
        "title_componentsLayerList_Vue": 'LayerList Widget(Vue)',
        "title_componentsOpenFile_Vue":'OpenFile Widget(Vue)',
        "title_componentsMap_Vue": 'Map Widget(Vue）',
        "title_componentsMiniMap_Vue": 'MiniMap Widget(Vue）',
        "title_componentsPan_Vue": 'Pan Widget(Vue）',
        "title_componentsScale_Vue": 'Scale Widget(Vue）',
        "title_componentsWebmap_Vue": 'WebMap Widget(Vue）',
        "title_componentsZoom_Vue": 'Zoom Widget(Vue）',
        "title_componentsLegend_Vue": 'Legend Widget(Vue）',
        "title_componentsBasic_Vue": 'Basic Widget(Vue）',
        "title_componentsMeasure_Vue": 'Measure Widget(Vue）',
        "title_componentsQuery_Vue": 'Query Widget(Vue）',
        ...
        "title_componentsGeoJSON_Vue": 'GeoJSON Layer Widget(Vue)',
        "title_componentsMapV_Vue": 'MapV Layer Widget(Vue)',
        "title_componentsDeckGL_Vue": 'DeckGL Layer Widget(Vue)',
        "title_componentsVectorTile_Vue": 'Vector Tile Layer Widget(Vue)',
        "title_componentsHeatmap_Vue": 'Heatmap Layer Widget(Vue)',
        "title_componentsGraphThemeLayer_Vue": 'Statistical Thematic Chart Widget(Vue)',
        "title_componentsUniqueTheme_Vue": 'UniqueTheme Layer Widget(Vue)',
        "title_componentsRangeTheme_Vue": 'RangeTheme Layer Widget(Vue)',
        "title_componentsRankSymbolTheme_Vue": 'RankSymbolTheme Layer Widget(Vue)',
        "title_componentsLabelTheme_Vue": 'LabelTheme Layer Widget(Vue)',
        "title_componentsDataFlow_Vue": 'Data FLow Layer Widget(Vue)',
