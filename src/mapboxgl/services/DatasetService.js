...
export class DatasetService extends ServiceBase {
    ...
    /**
     * @function mapboxgl.supermap.DatasetService.prototype.getDatasets
     * @description 数据集查询服务。
     * @example
     *   new mapboxgl.supermap.DatasetService(url).getDatasets(datasourceName,function(result){
     *     //doSomething
     *   });
    ...
    /**
     * @function mapboxgl.supermap.DatasetService.prototype.getDataset
     * @description 数据集查询服务。
     * @example
     *   new mapboxgl.supermap.DatasetService(url).getDataset(datasourceName, datasetName, function(result){
     *     //doSomething
     *   });
     * @param {string} datasourceName - 数据源名称。
    ...
    /**
     * @function mapboxgl.supermap.DatasetService.prototype.setDataset
     * @description 数据集信息设置服务。可实现修改已存在数据集，新增不存在数据集。
     * @example
     *   new mapboxgl.supermap.DatasetService(url).setDataset(params, function(result){
     *     //doSomething
     *   });
    ...
    /**
     * @function mapboxgl.supermap.DatasetService.prototype.deleteDataset
     * @description 指定数据源下的数据集删除服务。
     * @example
     *   new mapboxgl.supermap.DatasetService(url).deleteDataset(datasourceName, datasetName, function(result){
     *     //doSomething
     *   });
     * @param {string} datasourceName - 数据源名称。
     * @param {string} datasetName - 数据集名称。
