...
export class TrafficTransferAnalystService extends ServiceBase {
    ...
    constructor(url, options) {
        super(url, options);
        this._trafficTransferAnalystServiceBase = new CommonTrafficTransferAnalystService(url, options);
    }
    ...
    queryStop(params, callback) {
      return this._trafficTransferAnalystServiceBase.queryStop(params, callback);
    }
    ...
    analysisTransferPath(params, callback) {
      return this._trafficTransferAnalystServiceBase.analysisTransferPath(params, callback);
    }
    ...
    analysisTransferSolution(params, callback) {
      return this._trafficTransferAnalystServiceBase.analysisTransferSolution(params, callback);
    }
    ...
    _processParams(params) {
        ...
        if (params.points && Util.isArray(params.points)) {
            params.points.map(function (point, key) {
                params.points[key] = (point instanceof maplibregl.LngLat) ? {
                    x: point.lng,
                    y: point.lat
                } : point;
