...
export class TrafficTransferAnalystService extends ServiceBase {
    ...
    queryStop(params, callback) {
      this._trafficTransferAnalystServiceBase.queryStop(params, callback);
    }
    ...
    analysisTransferPath(params, callback) {
      this._trafficTransferAnalystServiceBase.analysisTransferPath(params, callback);
    }
    ...
    analysisTransferSolution(params, callback) {
      this._trafficTransferAnalystServiceBase.analysisTransferSolution(params, callback);
    }
