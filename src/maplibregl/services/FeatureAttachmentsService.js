 ...
 * which accompanies this distribution and is available at http://www.apache.org/licenses/LICENSE-2.0.html.*/
  ...
  * @usage
  */
 export class FeatureAttachmentsService extends ServiceBase {
     ...
     attachmentsSupport(params, callback) {
        if (!params) {
            return null;
        }
     ...
     /**
      * @function FeatureAttachmentsService.prototype.featureAttachments
      * @param {EditFeatureAttachmentsParameters} params - 数据服务栅格查询参数类。
      * @param {RequestCallback} callback - 回调函数。
      */
     featureAttachments(params, callback) {
         if (!params) {
             return null;
         }
