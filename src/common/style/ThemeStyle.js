 ...
 * @classdesc 客户端专题图风格类。该类用于设置客户端专题图的点、线、面和文本样式。
 ...
 * @param {boolean} [options.stroke=false] -  是否描边，不需要描边则设置为 false。如果 fill 与 stroke 同时为 false，将按 fill 与 stroke 的默认值渲染图层。
 ...
 * @param {string} [options.shadowColor='#000000'] - 十六进制阴影颜色。注：请将 shadowColor 属性与 shadowBlur 属性一起使用，来创建阴影。
 ...
 * @param {number} [options.fontSize=12] - 附加文本字体大小，单位为像素。
 ...
 * @param {string} [options.labelAlign='center'] - 附加文本水平对齐方式。可以是 'left', 'right', 'center'。
 * @param {string} [options.labelBaseline='middle'] - 附加文本垂直对齐方式。可以是 'top', 'bottom', 'middle'。
 * @param {number} [options.labelXOffset=0] - 附加文本在 x 轴方向的偏移量。
 * @param {number} [options.labelYOffset=0] - 附加文本在 y 轴方向的偏移量。
 * @usage
 */
export class ThemeStyle {
    ...
    constructor(options) {
         ...
         * @description  是否描边，不需要描边则设置为 false。如果 fill 与 stroke 同时为 false，将按 fill 与 stroke 的默认值渲染图层。
         */
        this.stroke = false;
        /**
         ...
         * @description 附加文本水平对齐方式。可以是 'left', 'right', 'center'。
         */
        this.labelAlign = "center";
        /**
         * @member {string} [ThemeStyle.prototype.labelBaseline='middle']
         * @description  附加文本垂直对齐方式。可以是 'top', 'bottom', 'middle'。
         */
