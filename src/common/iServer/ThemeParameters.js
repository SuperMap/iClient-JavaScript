 ...
 * @param {Array.<SuperMap.JoinItem>} [options.joinItems] - 专题图外部表的连接信息 JoinItem 数组。
 * @param {Array.<SuperMap.Theme>} options.themes - 专题图对象列表。
...
export class ThemeParameters {
    ...
    constructor(options) {
         ...
         * @property {string} fieldValuesDisplayMode - 目前有两个DISPLAY/DISABLE。当为DISPLAY时，表示只显示以上设置的相应属性值的要素，否则表示不显示以上设置的相应属性值的要素。
         */
