 ...
 * @param {ModulePolyline} options.sourceRoute - 路由对象。该对象可以是用户自己生成或在数据源中查询得到的符合标准的路由对象。
...
export class RouteCalculateMeasureParameters {
    ...
    constructor(options) {
        ...
        /**
         * @member {ModulePolyline} RouteCalculateMeasureParameters.prototype.sourceRoute
