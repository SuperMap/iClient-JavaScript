 ...
 * @param {string} options.unique - 单值标签专题图子项的值，可以为数字、字符串等。
 * @param {string} [options.caption] - 单值标签专题图子项的名称。
 * @param {number} [options.offsetX=0] - 标签在 X 方向偏移量。
 * @param {number} [options.offsetY=0] - 标签在 Y 方向偏移量。
 * @param {boolean} [options.visible=true] - 单值标签专题图子项是否可见。
 * @param {ServerTextStyle} [options.style] - 单值标签专题图子项文本的显示风格。
 * @usage
 */
export class ThemeLabelUniqueItem {
    ...
    constructor(options) {
         ...
         * @description 单值标签专题图子项的标题。
         */
        this.caption = null;

        /**
         * @member {string} ThemeLabelUniqueItem.prototype.unique
         * @description 单值标签专题图子项的值，可以为数字、字符串等。
         */
        this.unique = null;
         ...
         * @description 单值标签专题图子项是否可见。如果为 true，则标签专题图子项可见。
         */
        this.visible = true;

        /**
         * @member {ServerTextStyle} ThemeLabelUniqueItem.prototype.style
         * @description 单值标签专题图子项文本的显示风格。各种风格的优先级从高到低为：<br>
