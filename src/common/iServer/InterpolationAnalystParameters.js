 ...
 * @param {string} [options.dataset] - 待分析的数据集名称。当插值分析类型（InterpolationAnalystType）为 dataset 时，此为必设参数。
...
export class InterpolationAnalystParameters {
    ...
    constructor(options) {
        ...
        /**
         * @member {ModuleBounds} InterpolationAnalystParameters.prototype.bounds
         ...
         * 当插值分析类型（InterpolationAnalystType）为 dataset 时，此为必设参数。
         */
         ...
         * @description 用于做插值分析的离散点（离散点包括 Z 值）集合。
         * 当插值分析类型（InterpolationAnalystType）为 geometry 时，此为必设参数。
