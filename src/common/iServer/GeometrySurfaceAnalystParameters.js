 ...
 * @param {Array.<GeometryPoint|L.LatLng|L.Point|ol.geom.Point>} options.points - 表面分析的坐标点数组。
...
export class GeometrySurfaceAnalystParameters extends SurfaceAnalystParameters {
    ...
    constructor(options) {
        super(options);
        /**
         * @member {Array.<GeometryPoint|L.LatLng|L.Point|ol.geom.Point>} GeometrySurfaceAnalystParameters.prototype.points
