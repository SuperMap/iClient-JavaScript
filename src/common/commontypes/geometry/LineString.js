...
export class LineString extends Curve {
    ...
    /**
     * @function LineString.prototype.removeComponent
    ...
    /**
     * @function LineString.prototype.getSortedSegments
    ...
    /**
     * @function LineString.prototype.getVertices
    ...
    /**
     * @function LineString.calculateCircle
     * @description 三点画圆弧。
     ...
     * var circle = LineString.calculateCircle(points);
     */
    ...
    /**
     * @function LineString.createLineEPS
     ...
     * var lineEPS = LineString.createLineEPS(points);
     */
