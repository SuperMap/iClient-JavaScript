 ...
 * @property {FeatureLine.style} [lineStyle] - 折线图中折线 style。
 * @property {Point.style} [pointStyle] - 折线图中折线节点基础 style，此参数控制折线节点基础样式，优先级低于 pointStyleByFields 和 pointStyleByCodomain。
 * @property {Point.style} [pointStyleByFields] - 按专题字段 themeFields（<SuperMap.Layer.Graph.themeFields>）为折线节点赋 style，此参数按字段控制折线节点样式，
