 ...
 * @param {Ring.setting} setting - 图表配置对象。
...
export class Ring extends Graph {
    ...
    /**
     * @function Ring.prototype.destroy
    ...
    /**
     * @function Ring.prototype.assembleShapes
 ...
 * @property {FeatureRectangle.style} [backgroundStyle] - 背景样式，此样式对象对象可设属性。
