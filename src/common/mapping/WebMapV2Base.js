...
export function createWebMapV2BaseExtending(SuperClass = Events, fireField = 'triggerEvent') {
  return class WebMapV2Base extends SuperClass {
    constructor(id, options, mapOptions) {
      ...
      this.excluortalProxyUrl = options.excludePortalProxyUrl;
      ...
      getLayerFunc &&
        getLayerFunc
          ...
          .catch(error => {
            ...
            this._fire('layercreatefailed', { error, layer, map: this.map });
            console.log(error);
          });
    }
