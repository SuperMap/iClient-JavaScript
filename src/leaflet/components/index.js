...
import { DataFlowViewModel, dataFlowViewModel } from './dataflow/DataFlowViewModel';

import { ClientComputationView, clientComputationView } from './clientcomputation/ClientComputationView';
import { ClientComputationViewModel, clientComputationViewModel } from './clientcomputation/ClientComputationViewModel';
...
import { DistributedAnalysisModel } from './distributedanalysis/DistributedAnalysisModel';
...
export { DataFlowViewModel, dataFlowViewModel };

export { ClientComputationView, clientComputationView };
export { ClientComputationViewModel, clientComputationViewModel };
...
export { DistributedAnalysisModel };
