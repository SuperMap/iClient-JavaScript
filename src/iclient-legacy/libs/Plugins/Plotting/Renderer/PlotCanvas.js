...
/**
 * SuperMap.Renderer.PlotCanvas
 * A renderer based on the 2D 'canvas' drawing element.
 * 
 * Inherits:
 *  - <SuperMap.Renderer.Canvas>
 */
SuperMap.Renderer.PlotCanvas = SuperMap.Class(SuperMap.Renderer.Canvas, {
    
    /**
     * Constructor: SuperMap.Renderer.PlotCanvas
     *
     * Parameters:
     * containerID - {<String>}
    ...
    initialize: function(containerID, options) {
        SuperMap.Renderer.Canvas.prototype.initialize.apply(this, arguments);
    },
    ...
    copyCellStyle: function(cellStyle, featureStyle, geometry){
        ...
        if(featureStyle.display && featureStyle.display === "none"){
            ...
            if(featureStyle.labelRotation) cellStyle.labelRotation = featureStyle.labelRotation;
            if(featureStyle.fontOpacity) cellStyle.fontOpacity = featureStyle.fontOpacity;
    ...
    CLASS_NAME: "SuperMap.Renderer.PlotCanvas"
});