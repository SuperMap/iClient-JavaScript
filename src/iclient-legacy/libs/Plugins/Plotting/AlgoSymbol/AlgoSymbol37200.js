 ...
 */
SuperMap.Geometry.AlgoSymbol37200 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    ...
    calculateParts: function () {
        ...
        var pt9 = new SuperMap.Geometry.Point(-0.3*dSymbolSize,0);
        var pt10 = new SuperMap.Geometry.Point(-0.3*dSymbolSize,0.2*dSymbolSize);
        var tempPt1_2 = SuperMap.Plot.PlottingUtil.coordinateTrans(symbolPt,pt2,subSymAngle);
        var tempPt1_9 = SuperMap.Plot.PlottingUtil.coordinateTrans(symbolPt,pt9,subSymAngle);
        var tempPt1_10 = SuperMap.Plot.PlottingUtil.coordinateTrans(symbolPt,pt10,subSymAngle);

        pts2D = [];
        pts2D.push(tempCenter);
        pts2D.push(tempPt1_2);
        pts2D.push(tempPt1_10);
        pts2D.push(tempPt1_9);
        ...
        var pt7 = SuperMap.Plot.PlottingUtil.circlePoint(centerPt2D,0.15*dSymbolSize,0.15*dSymbolSize,45);
        var pt8 = SuperMap.Plot.PlottingUtil.circlePoint(centerPt2D,0.15*dSymbolSize,0.15*dSymbolSize,315);

        var tempPt1_7 = SuperMap.Plot.PlottingUtil.coordinateTrans(symbolPt,pt7,subSymAngle);
        var tempPt1_8 = SuperMap.Plot.PlottingUtil.coordinateTrans(symbolPt,pt8,subSymAngle);

        pts2D = [];
        pts2D.push(tempPt1_7);
        pts2D.push(tempCenter);
        pts2D.push(tempPt1_8);
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol37200"
});
