 ...
 */
SuperMap.Geometry.AlgoSymbol1009 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol,{
    ...
    calculateParts: function () {
        ...
        //箭尾拟合点
        var tailPts = SuperMap.Plot.ArrowToolKit.generateArrowTailShapePts(geoPts,lastPts,scaleValue, SuperMap.Plot.ArrowToolKit.ArrowTailType.ARROWTAIL_COATTAIL);

        //创建箭身
        var arrowBodyGeometry = SuperMap.Geometry.Primitives.transformSymbolCellToGeometry(SuperMap.Plot.SymbolType.POLYLINESYMBOL, ptsClone);
        arrowBodyGeometry.style = {surroundLineFlag: false};
        this.components.push(arrowBodyGeometry);
        this.addOrRemoveSurroundLine(arrowBodyGeometry);
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol1009"
});