 ...
 */
SuperMap.Geometry.AlgoSymbol41200 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    ...
    calculateParts: function () {
        ...
        //
        var ptranglept1 = new SuperMap.Geometry.Point(symbolPt.x,symbolPt.y);
        var ptranglept2 = new SuperMap.Geometry.Point((symbolPt.x-dDis),(symbolPt.y-dDis));
        var ptranglept3 = new SuperMap.Geometry.Point((symbolPt.x+dDis),(symbolPt.y-dDis));
        var ptranglept4 = new SuperMap.Geometry.Point((symbolPt.x-dDis),(symbolPt.y+dDis));
        var ptranglept5 = new SuperMap.Geometry.Point((symbolPt.x+dDis),(symbolPt.y+dDis));
        ...
        cellpts.push(ptranglept1);
        cellpts.push(ptranglept4);
        cellpts.push(ptranglept5);
        cellpts.push(ptranglept1);
        this.addCell(SuperMap.Plot.SymbolType.POLYLINESYMBOL,cellpts,{lineTypeLimit:true,surroundLineLimit:true});
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol41200"
});
