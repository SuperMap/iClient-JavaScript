 ...
 */
SuperMap.Geometry.AlgoSymbol39802 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    HEADLINESCALE	:0.05,
    CIRCLESCALE		:0.03,
    CIRCLEPOS		:0.5,
    ...
    calculateParts: function () {
        ...
        //平行线1
        var para1 = [];
        para1 = SuperMap.Plot.PlottingUtil.paraLine(ptsarr, 2*dLineDis, false);
        SuperMap.Plot.PlottingUtil.clearSamePts(para1);

        this.addCell(SuperMap.Plot.SymbolType.POLYLINESYMBOL,para1);

        //平行线2
        var para2 = [];
        para2 = SuperMap.Plot.PlottingUtil.paraLine(ptsarr, 2*dLineDis, true);
        SuperMap.Plot.PlottingUtil.clearSamePts(para2);
        this.addCell(SuperMap.Plot.SymbolType.POLYLINESYMBOL,para2);
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol39802"
});
