 ...
 */
SuperMap.Geometry.AlgoSymbol17401 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    /**
        ...
        for(var dStepX = minX; dStepX < maxX; dStepX += dSapce)
        {
            for(var dStepY = minY; dStepY < maxY; dStepY += dSapce)
            {
                ...
                if(fill){
                    ...
                    this.addCell(SuperMap.Plot.SymbolType.ARBITRARYPOLYGONSYMBOL, pts2D, null, true);
                }
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol17401"
});
