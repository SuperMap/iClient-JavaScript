 ...
 */
SuperMap.Geometry.AlgoSymbol37601 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    /**
    ...
    calculateParts: function () {
        ...
        if(this.subSymbols.length > 0){
            this.computeSubSymbol(this.subSymbols[0],symbolPt,dSymbolSize, 90);
        }
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol37601"
});
