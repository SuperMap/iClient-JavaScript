 ...
 */
SuperMap.Geometry.AlgoSymbol1013 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol1007,{
    ...
    initialize:function(option){
        ...
        if((undefined === option.constantSize || null === option.constantSize) && this.saveGeoData === false) {
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol1013"
});