 ...
 */
SuperMap.Geometry.AlgoSymbol17802 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    ...
    calculateParts: function () {
        ...
        //中间圆
        var pCellPt1 = SuperMap.Plot.PlottingUtil.circlePoint(ptStart,0.15*dis,0.15*dis,dAngle);
        var pCellPt2 = SuperMap.Plot.PlottingUtil.circlePoint(ptStart,0.08*dis,0.08*dis,dAngle+90);
        var pCellPt3 = SuperMap.Plot.PlottingUtil.circlePoint(ptStart,0.15*dis,0.15*dis,dAngle+180);
        var pCellPt4 = SuperMap.Plot.PlottingUtil.circlePoint(ptStart,0.08*dis,0.08*dis,dAngle+270);
        pts2D.push(pCellPt1.clone());
        pts2D.push(pCellPt2.clone());
        pts2D.push(pCellPt3.clone());
        pts2D.push(pCellPt4.clone());
        ...
        //第二条折线
        var pt3 = SuperMap.Plot.PlottingUtil.circlePoint(ptStart, 0.15*dis,0.15*dis,dAngle+180);
        ...
        //左边第一条折线
        var pt5 = SuperMap.Plot.PlottingUtil.circlePoint(ptStart, 0.15*dis,0.15*dis,dAngle);
