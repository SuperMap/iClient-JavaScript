 ...
 */
SuperMap.Geometry.AlgoSymbol42400 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    /**
    ...
    calculateParts: function () {
        ...
        var cellpts = [];
        cellpts.push(new SuperMap.Geometry.Point(plygonCenter.x+dX,plygonCenter.y+dY));
        cellpts.push(new SuperMap.Geometry.Point(plygonCenter.x+dX+dRadius,plygonCenter.y+dY));
        this.addCell(SuperMap.Plot.SymbolType.CIRCLESYMBOL,cellpts,{fill:false});

        //计算比例点
        this.scalePoints = [];
        this.addScalePoint(new SuperMap.Geometry.Point(plygonCenter.x+dX+dRadius,plygonCenter.y+dY));
        this.addScalePoint(new SuperMap.Geometry.Point(plygonCenter.x+dX,plygonCenter.y+dY));
    },
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol42400"
});
