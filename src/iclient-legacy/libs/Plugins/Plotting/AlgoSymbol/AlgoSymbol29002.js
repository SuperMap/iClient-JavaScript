 ...
 */
SuperMap.Geometry.AlgoSymbol29002 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    CARSCALE:  0.1,
    ...
    initialize: function (option) {
        ...
        this.scaleValues = [];
        this.subSymbols.push(new SuperMap.Plot.SubSymbol(100, 600));
        this.subSymbols.push(new SuperMap.Plot.SubSymbol(100, 5300));
    },
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol29002"
});
