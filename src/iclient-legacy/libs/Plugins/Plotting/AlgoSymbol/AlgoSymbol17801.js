 ...
 */
SuperMap.Geometry.AlgoSymbol17801 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    ...
    initialize: function (option) {
        ...
        this.scaleValues = [];
        this.scaleValues.push(0.1);//内部符号的大小/定位点间连线的长度和。（首尾不相连）
    ...
    calculateParts: function () {
        ...
        //中间圆
        var ptCircle = SuperMap.Plot.PlottingUtil.circlePoint(ptStart,0.1*dis,0.1*dis,0);
        pts2D.push(geoPts[0].clone());
        pts2D.push(ptCircle.clone());
