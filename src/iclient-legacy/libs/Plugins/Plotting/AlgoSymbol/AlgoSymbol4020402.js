 ...
 */
SuperMap.Geometry.AlgoSymbol4020402 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol30100, {
    ...
    calculateParts: function () {
        ...
        var ptLine1 = SuperMap.Plot.PlottingUtil.circlePoint(center2D, distance *0.75, distance *0.75, angle + scaleAngle);
        ...
        var ptL1 = new SuperMap.Geometry.Point(0, 0.25 * distance6);
        var ptL2 = new SuperMap.Geometry.Point(0.5 * distance6, 0);
        var ptL3 = new SuperMap.Geometry.Point(0, -0.25 * distance6);
        var ptL4 = new SuperMap.Geometry.Point(-0.5 * distance6, 0);
        ...
        var ptR1 = new SuperMap.Geometry.Point(0.5 * distance6, -0.25 * distance6);
        var ptR2 = new SuperMap.Geometry.Point(-0.25 * distance6, -0.25 * distance6);
        var ptR3 = new SuperMap.Geometry.Point(-0.5 * distance6, 0.25 * distance6);
        var ptR4 = new SuperMap.Geometry.Point(0.5 * distance6, 0.25 * distance6);
