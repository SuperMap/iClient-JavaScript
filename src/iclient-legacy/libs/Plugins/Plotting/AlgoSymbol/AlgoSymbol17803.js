 ...
 */
SuperMap.Geometry.AlgoSymbol17803 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    ...
    calculateParts: function () {
        ...
        var dis = dAllDistance*dScale2;

        //子符号
        var pt1 = new SuperMap.Geometry.Point(-0.5*dis,0.25*dis);
        var pt2 = new SuperMap.Geometry.Point(-0.4*dis,0.125*dis);
        var pt3 = new SuperMap.Geometry.Point(0.4*dis,0.125*dis);
        var pt4 = new SuperMap.Geometry.Point(0.5*dis,0.25*dis);
        ...
        //
        var pt5 = new SuperMap.Geometry.Point(-0.5*dis,-0.25*dis);
        var pt6 = new SuperMap.Geometry.Point(-0.4*dis,-0.125*dis);
        var pt7 = new SuperMap.Geometry.Point(0.4*dis,-0.125*dis);
        var pt8 = new SuperMap.Geometry.Point(0.5*dis,-0.25*dis);
