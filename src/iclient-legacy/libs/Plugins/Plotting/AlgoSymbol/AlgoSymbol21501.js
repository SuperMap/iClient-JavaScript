 ...
 */
SuperMap.Geometry.AlgoSymbol21501 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    ...
    calculateParts: function () {
        ...
        if (dDelta >= dRadius) {
            ...
            for (var i = circlePtIndex; i < shapePts.length; i++) {
                var tempPt3 = shapePts[i].clone();
                var tempPt4 = circlePt.clone();
                var dispt1 = SuperMap.Plot.PlottingUtil.distance(tempPt3, tempPt4);
                if (dispt1 > dRadius) {//点到圆心的距离大于半径
                    pos2 = i;
                    break;
                }
            }
    ...
    modifyPoint: function (index, pt) {
        if (pt.isScalePoint) {
            ...
            if (index === 0) {
                ...
                var dScale = distance / dalldistance;
                if(dScale < 0.3){
    ...
    CLASS_NAME: "SuperMap.Geometry.AlgoSymbol21501"
});