 ...
 */
SuperMap.Geometry.AlgoSymbol1008 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol,{
    ...
    calculateParts: function () {
        ...
        var headPts = SuperMap.Plot.ArrowToolKit.generateArrowHeadShapePtsBySingleLine(geoPts,ptsClone,lastPts,scaleValue,bodyResult.arrowHeadLen, SuperMap.Plot.ArrowToolKit.ArrowHeadType.ARROWHEAD_COATTAIL);

        //创建箭身
        this.addCell(SuperMap.Plot.SymbolType.POLYLINESYMBOL,ptsClone);

        //创建箭头
        var style = {surroundLineFlag: false,fillLimit:true,fillStyle:true};
        this.addCell(SuperMap.Plot.SymbolType.ARBITRARYPOLYGONSYMBOL, headPts,style);

        this.clearBounds();
    },

    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol1008"
});