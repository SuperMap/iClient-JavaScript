 ...
 */
SuperMap.Geometry.AlgoSymbol17804 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    ...
    calculateParts: function () {
        ...
        //子符号
        var pt1 = new SuperMap.Geometry.Point(-0.5*dis,0.5*dScaleDis);
        var pt2 = new SuperMap.Geometry.Point(0.5*dis,0.5*dScaleDis);
        ...
        //
        var pt3 = new SuperMap.Geometry.Point(-0.5*dis,-0.5*dScaleDis);
        var pt4 = new SuperMap.Geometry.Point(0.5*dis,-0.5*dScaleDis);
        ...
        //
        var pt5 = new SuperMap.Geometry.Point(-0.10*dis, 0.5*dScaleDis);
        var pt6 = new SuperMap.Geometry.Point(-0.15*dis,-0.5*dScaleDis);
        ...
        //
        var pt7 = new SuperMap.Geometry.Point(0.15*dis, 0.5*dScaleDis);
        var pt8 = new SuperMap.Geometry.Point(0.10*dis,-0.5*dScaleDis);
        ...
        var scalePt2 = SuperMap.Plot.PlottingUtil.circlePoint(symbolPt, 0.5 * dScaleDis, 0.5 * dScaleDis, 90);
