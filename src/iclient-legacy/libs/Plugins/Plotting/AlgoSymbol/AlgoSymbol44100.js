 ...
 */
SuperMap.Geometry.AlgoSymbol44100 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    SUBSYMSCALE :0.2,
    ...
    calculateParts: function () {
        ...
        //由定位点计算三角形的两个底角定位点
        var Trangledis = dDistance*0.06;
        var sidepoint = SuperMap.Plot.PlottingUtil.getSidePointsOfLine(Trangledis,ptEnd,ptStart);
        var Tranglept1 = sidepoint.pntRight;
        var Tranglept2 = sidepoint.pntLeft;

        TranglePts.push(Tranglept1);
        TranglePts.push(Tranglept2);

        Trangledis = dDistance*0.15;
        var Tranglept3 = new SuperMap.Geometry.Point(Trangledis,0);
        var temppt = SuperMap.Plot.PlottingUtil.coordinateTrans(ptStart,Tranglept3,angle);
        TranglePts.push(temppt);

        this.addCell(SuperMap.Plot.SymbolType.ARBITRARYPOLYGONSYMBOL, TranglePts,{lineColorLimit:true,strokeColor:"#0000FF",fillLimit:true,fillStyle:0,fillColor:"#0000FF"});
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol44100"
