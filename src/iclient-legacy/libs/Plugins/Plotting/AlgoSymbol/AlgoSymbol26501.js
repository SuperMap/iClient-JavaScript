 ...
 */
SuperMap.Geometry.AlgoSymbol26501 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    HEADSCALE :0.03,
    CORNSCALE :0.5,
    DISTANCE :2,
    ...
    initialize: function (option) {
        ...
        if(this.subSymbols >= 0){
            this.subSymbols.push(new SuperMap.Plot.SubSymbol(100, 22100));
        }
    },
    ...
    calculateParts: function () {
        ...
        if(this.subSymbols.length > 0){
            this.computeSubSymbol(this.subSymbols[0], circlePt, dsymbolsize, dangle);
        }
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol26501"
});