 ...
 */
SuperMap.Geometry.AlgoSymbol40000 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    HEADLINESCALE	:0.05,
    CIRCLESCALE		:0.03,
    CIRCLEPOS		:0.5,
    ...
    calculateParts: function () {
        ...
        var style = {lineColorLimit:true,strokeColor:"#0000FF"};
        this.addCell(SuperMap.Plot.SymbolType.POLYLINESYMBOL,ptsLeft,style);
        this.addCell(SuperMap.Plot.SymbolType.POLYLINESYMBOL,ptsRight,style);
        ...
        this.addCell(SuperMap.Plot.SymbolType.CIRCLESYMBOL,cellpts,style);
        ...
        cellpts.push(pt1);
        cellpts.push(pt2);
        this.addCell(SuperMap.Plot.SymbolType.POLYLINESYMBOL,cellpts,style);
        ...
        //箭头
        var pt5 = SuperMap.Plot.PlottingUtil.circlePoint(symbolCenterPt,dSymbolDis/2.0,dSymbolDis/2.0,symbolAngle);
        var pt6 = SuperMap.Plot.PlottingUtil.circlePoint(pt5,2.0*dSymbolDis,2.0*dSymbolDis,symbolAngle+150);
        var pt7 = SuperMap.Plot.PlottingUtil.circlePoint(pt5,2.0*dSymbolDis,2.0*dSymbolDis,symbolAngle+330);
        ...
        var pt8 = SuperMap.Plot.PlottingUtil.circlePoint(pt5,1.5*dSymbolDis,1.5*dSymbolDis,symbolAngle+330);
        var pt9 = SuperMap.Plot.PlottingUtil.circlePoint(pt8,0.125*dSymbolDis,0.125*dSymbolDis,symbolAngle+330+90);
        var pt10 = SuperMap.Plot.PlottingUtil.circlePoint(pt8,0.125*dSymbolDis,0.125*dSymbolDis,symbolAngle+330+270);
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol40000"
});
