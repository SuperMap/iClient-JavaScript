 ...
 */
SuperMap.Geometry.AlgoSymbol42200 = new SuperMap.Class(SuperMap.Geometry.AlgoSymbol, {
    /**
    ...
    initialize: function (option) {
        ...
        if(this.subSymbols >= 0){
            this.subSymbols.push(new SuperMap.Plot.SubSymbol(100, 20901));
        }
    },
    ...
    calculateParts: function () {
        ...
        //计算比例点
        this.scalePoints = [];
        this.addScalePoint(new SuperMap.Geometry.Point(plygonCenter.x+dX+dSymbolSize,plygonCenter.y+dY));
    ...
    CLASS_NAME:"SuperMap.Geometry.AlgoSymbol42200"
});
