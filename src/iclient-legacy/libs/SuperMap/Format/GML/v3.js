...
/**
 * Class: SuperMap.Format.GML.v3
 * Parses GML version 3.
 *
 * Inherits from:
 *  - <SuperMap.Format.GML.Base>
 */
SuperMap.Format.GML.v3 = SuperMap.Class(SuperMap.Format.GML.Base, {
    ...
    /**
     * Constructor: SuperMap.Format.GML.v3
        ...
        "gml": SuperMap.Util.applyDefaults({
            ...
            "posList": function(node, obj) {
                ...
                for(var i=0, len=coords.length; i<len; i += dim) {
                    ...
                    if (this.xy) {
                        points[i/dim] = new SuperMap.Geometry.Point(x, y, z);
                    } else {
                        points[i/dim] = new SuperMap.Geometry.Point(y, x, z);
                    }
                }
                obj.points = points;
            },
    ...
    setGeometryTypes: function() {
        this.geometryTypes = {
            ...
            "SuperMap.Geometry.LineString": (this.curve === true) ? "Curve": "LineString",
            "SuperMap.Geometry.MultiLineString": (this.multiCurve === false) ? "MultiLineString" : "MultiCurve",
            "SuperMap.Geometry.Polygon": (this.surface === true) ? "Surface" : "Polygon",
            "SuperMap.Geometry.MultiPolygon": (this.multiSurface === false) ? "MultiPolygon" : "MultiSurface",
            "SuperMap.Geometry.Collection": "GeometryCollection"
        };
    },
    
    CLASS_NAME: "SuperMap.Format.GML.v3" 
