...
/**
 * Class: SuperMap.REST.MathExpressionAnalysisResult
 * 栅格代数运算服务结果数据类
 *
 * Inherits from:
 *  - <SuperMap.REST.SpatialAnalystResult>
 */
SuperMap.REST.MathExpressionAnalysisResult = SuperMap.Class(SuperMap.REST.SpatialAnalystResult,{
    /**
     * Property: recordset
    ...
    /**
     * Constructor: SuperMap.REST.MathExpressionAnalysisResult
     * 栅格代数运算结果构造函数。
     *
     * Parameters:
     * options - {Object} 可选参数。
    ...
    CLASS_NAME: "SuperMap.REST.MathExpressionAnalysisResult"
});

SuperMap.REST.MathExpressionAnalysisResult.fromJson = function (jsonObject) {
    if (!jsonObject) {
        return;
    }
    var result = new SuperMap.REST.MathExpressionAnalysisResult();
