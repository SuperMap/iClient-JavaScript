...
SuperMap.REST.FacilityAnalystTracedown3DService = SuperMap.Class(SuperMap.ServiceBase, {
    ...
    EVENT_TYPES: [ 
     ...
     /**
     * APIProperty: events
     * {<SuperMap.Events>} 在 FacilityAnalystTracedown3DService 类中处理所有事件的对象，支持两种事件 processCompleted 、processFailed ，服务端成功返回最近设施分析结果时触发 processCompleted  事件，服务端返回最近设施分析结果失败触发 processFailed 事件。
     *    
     */ 
    events: null,
    ...
    /** 
     * Property: lastResult
     * {<SuperMap.REST.FacilityAnalystTracedown3DResult>} 服务端返回的最近设施分析结果数据。  
     */
    lastResult: null,
    ...
    findClosestFacilityComplete: function(result) {
        var me = this,
            FacilityAnalystTracedown3DResult, fe;
        result = SuperMap.Util.transformResult(result);
        FacilityAnalystTracedown3DResult = SuperMap.REST.FacilityAnalystTracedown3DResult.fromJson(result);
        me.lastResult = FacilityAnalystTracedown3DResult;
        fe = new SuperMap.REST.FacilityAnalystTracedown3DEventArgs(FacilityAnalystTracedown3DResult, result);
