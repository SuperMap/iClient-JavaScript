...
SuperMap.Layer.Siweidg = SuperMap.Class(SuperMap.CanvasLayer, {
    ...
    /**
     * APIProperty: url
     * {String} 地图资源地址。默认为：http://www.supermapol.com/iserver/services/map-siweidg/rest/maps/${layerType}/tileImage.png?transparent=true&cacheEnabled=true&width=256&height=256&x=${x}&y=${y}&scale=${scale}
     */
    url: 'http://www.supermapol.com/iserver/services/map-siweidg/rest/maps/${layerType}/tileImage.png?transparent=true&cacheEnabled=true&width=256&height=256&x=${x}&y=${y}&scale=${scale}',
    ...
    /**
     * Constructor: SuperMap.Layer.Siweidg
     * 四维世景服务图层类。
     *
     * Parameters:
...
//            resolutions: [156605.46875, 78302.734375, 39151.3671875, 19575.68359375, 9787.841796875, 4893.9208984375, 2446.96044921875, 1223.48022460937, 611.740112304687, 305.870056152344, 152.935028076172, 76.4675140380859, 38.233757019043, 19.1168785095215, 9.55843925476074, 4.77921962738037, 2.38960981369019, 1.19480490684509, 0.597402453422546]
     ...
     *
     * Returns:
     * {<SuperMap.Layer.Siweidg>}新的图层。
     */
    clone: function (obj) {
        var me = this;
        if (obj == null) {
            obj = new SuperMap.Layer.Siweidg(
                me.name, me.url, me.layerName, me.layerType, me.getOptions());
        }
    ...
    CLASS_NAME: "SuperMap.Layer.Siweidg"
});
