...
ol.source.Range = function (name, opt_options) {
    GeoFeature.call(this, name, opt_options);
    this.style = new Object();
    this.styleGroups = [];
    this.themeField = null;
};
ol.inherits(ol.source.Range, GeoFeature);

ol.source.Range.prototype.destroy = function () {
    this.style = null;
    this.themeField = null;
...
ol.source.Range.prototype.addFeatures = function (features) {
    //数组
...
ol.source.Range.prototype.createThematicFeature = function (feature) {
    //赋 style
...
ol.source.Range.prototype.getStyleByData = function (fea) {
    var style = {};
    var feature = fea;
...
ol.source.Range.prototype.canvasFunctionInternal_ = function (extent, resolution, pixelRatio, size, projection) {
    return GeoFeature.prototype.canvasFunctionInternal_.apply(this, arguments);
};

module.exports = ol.source.Range;