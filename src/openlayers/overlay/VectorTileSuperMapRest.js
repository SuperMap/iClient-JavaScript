...
export class VectorTileSuperMapRest extends VectorTile {
  constructor(options) {
    ...
    super({
      ...
      state: options.format instanceof MVT && options.style && Object.prototype.toString.call(options.style) == '[object String]' ? 'loading' : options.state,
      tileClass: options.tileClass,
      tileGrid: options.tileGrid,
      tilePixelRatio: options.tilePixelRatio,
      tileUrlFunction: options.format instanceof MVT && options.style ? zxyTileUrlFunction : tileUrlFunction,
      tileLoadFunction: options.format instanceof MVT ? undefined : tileLoadFunction,
      url: options.url,
      urls: options.urls,
