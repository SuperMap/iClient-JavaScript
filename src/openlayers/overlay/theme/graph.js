...
ol.source.Graph = function (name, chartsType, opt_options) {
...
ol.inherits(ol.source.Graph, Theme);

ol.source.Graph.prototype.destroy = function () {
...
ol.source.Graph.prototype.setChartsType = function (chartsType) {
    this.chartsType = chartsType;
    this.redraw();
};

ol.source.Graph.prototype.addFeatures = function (features) {
    //数组
...
ol.source.Graph.prototype.redrawThematicFeatures = function (extent, zoomChanged, dragging) {
    //清除当前所有可视元素
...
ol.source.Graph.prototype.createThematicFeature = function (feature) {
    var thematicFeature;
    // 检查图表创建条件并创建图形
...
ol.source.Graph.prototype.drawCharts = function () {
    // 判断 rendere r就绪
...
ol.source.Graph.prototype.getShapesByFeatureID = function (featureID) {
    var list = [];
...
ol.source.Graph.prototype.isQuadrilateralOverLap = function (quadrilateral, quadrilateral2) {
...
ol.source.Graph.prototype.isPointInPoly = function (pt, poly) {
...
ol.source.Graph.prototype.isChartInMap = function (mapPxBounds, chartPxBounds) {
    var mb = mapPxBounds;
    var isIn = false;
...
ol.source.Graph.prototype.clearCache = function () {
    this.cache = {};
    this.charts = [];
};

ol.source.Graph.prototype.removeFeatures = function (features) {
    this.clearCache();
    SuperMap.Layer.Theme.prototype.removeFeatures.apply(this, arguments);
};

ol.source.Graph.prototype.removeAllFeatures = function () {
    this.clearCache();
    SuperMap.Layer.Theme.prototype.removeAllFeatures.apply(this, arguments);
};

ol.source.Graph.prototype.redraw = function () {
    this.clearCache();
    return SuperMap.Layer.Theme.prototype.redraw.apply(this, arguments);
};

ol.source.Graph.prototype.clear = function () {
    if (this.renderer) {
        this.renderer.clearAll();
...
ol.source.Graph.prototype.canvasFunctionInternal_ = function (extent, resolution, pixelRatio, size, projection) {
    return Theme.prototype.canvasFunctionInternal_.apply(this, arguments);
};

module.exports = ol.source.Graph;