...
/**
 * Class: SuperMap.iServer.GetFieldsService
...
SuperMap.iServer.GetFieldsService = SuperMap.Class(SuperMap.ServiceBase, {
     ...
     * 例如：
     *     (start code) 
     * var myService = new SuperMap.iServer.GetFieldsService(url); 
     * myService.events.on({
    ...
    /**
     * Constructor: SuperMap.iServer.GetFieldsService
     * 字段查询服务构造函数。     
     * 
     * 例如：
     * (start code)     
     * var myService = new SuperMap.iServer.GetFieldsService(url, {eventListeners: {
     *     "processCompleted": getFieldsCompleted, 
     *     "processFailed": getFieldsError
     *     },
     *     datasource: "World",
    ...
    CLASS_NAME: "SuperMap.iServer.GetFieldsService"
});
