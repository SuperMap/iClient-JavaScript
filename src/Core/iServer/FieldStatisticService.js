...
/**
 * Class: SuperMap.iServer.FieldStatisticService
...
SuperMap.iServer.FieldStatisticService = SuperMap.Class(SuperMap.ServiceBase, {
     ...
     * 例如：
     *     (start code) 
     * var myService = new SuperMap.iServer.FieldStatisticService(url); 
     * myService.events.on({
    ...
    /**
     * Constructor: SuperMap.iServer.FieldStatisticService
     * 字段查询统计服务类构造函数。     
     * 
     * 例如：
     * (start code)     
     * var myService = new SuperMap.iServer.FieldStatisticService(url, {eventListeners: {
     *     "processCompleted": fieldStatisticCompleted, 
     *     "processFailed": fieldStatisticError
     *     }，
     *     datasource: "World",
    ...
    CLASS_NAME: "SuperMap.iServer.FieldStatisticService"
});
