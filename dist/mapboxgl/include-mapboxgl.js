...
(function () {
    ...
    function load({ libsurl, disturl }) {
        ...
        if (inArray(includes, 'draw')) {
            inputCSS(`${libsurl}/mapbox-gl-js/plugins/mapbox-gl-draw/1.3.0/mapbox-gl-draw.css`);
            inputScript(`${libsurl}/mapbox-gl-js/plugins/mapbox-gl-draw/1.3.0/mapbox-gl-draw.js`);
        }
        ...
        if (inArray(includes, 'proj4')) {
            inputScript(`${libsurl}/proj4/2.7.5/proj4.js`);
        }
        ...
        if (inArray(includes, 'antd')) {
            ...
            inputScript(`${libsurl}/moment/2.29.1/moment.min.js`);
        ...
        if (inArray(includes, 'canvg')) {
            inputScript(`${libsurl}/canvg/canvg.min.js`);
        }
        ...
        if (inArray(includes, 'OBJLoader')) {
            inputScript(`${libsurl}/three/0.121.1/examples/js/loaders/OBJLoader.js`);
        }
        ...
        if (inArray(includes, 'OBJLoader2')) {
            inputScript(`${libsurl}/three/0.129.0/build/three.min.js`);
        ...
        if (inArray(includes, 'MTLLoader')) {
            inputScript(`${libsurl}/three/0.121.1/examples/js/loaders/MTLLoader.js`);
        }
        if (inArray(includes, 'GLTFLoader')) {
            inputScript(`${libsurl}/three/0.121.1/examples/js/loaders/GLTFLoader.js`);
        }
