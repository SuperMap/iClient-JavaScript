...
describe('testCurve', function () {
    ...
    it("init", function () {
        var init = new SuperMap.LevelRenderer.Tool.Curve();
        expect(init.vector instanceof SuperMap.LevelRenderer.Tool.Vector).toBeTruthy();
        expect(init.EPSILON).toBe(1e-4);
        expect(init.THREE_SQRT).toBe(Math.sqrt(3));
        expect(init.ONE_THIRD).toBe(1 / 3);
    });

    it("isAroundZero", function () {
        var val = 1e-5;
        var init = new SuperMap.LevelRenderer.Tool.Curve();
    ...
    it("cubicRootAt_A&B&b_aroundZero", function () {
    ...
    it("cubicRootAt_A&B_aroundZero_b_isNot_zero", function () {
    ...
    it("cubicRootAt_A&B_notAroundZero_delta_moreThanZero", function () {
    ...
    it("cubicRootAt_A&B_notAroundZero_delta_lessThanZero", function () {
    ...
    it("cubicExtrema_a_isNotAroundZero", function () {
    ...
    it("cubicExtrema_a_isAroundZero", function () {
    ...
    it("quadraticDerivativeAt", function () {
        var p0 = 1, p1 = 5, p2 = 10, t = 0.8;
        var init = new SuperMap.LevelRenderer.Tool.Curve();
    ...
    it("quadraticRootAt_a_isAroundZero", function () {
    ...
    it("quadraticRootAt_a_isNotAroundZero_delta_equalToZero", function () {
    ...
    it("quadraticRootAt_a_isNotAroundZero_delta_moreThanZero", function () {
    ...
    it("quadraticExtremum_divider_NotToBe_Zero", function () {
        var p0 = 3, p1 = 1, p2 = 5;
        var init = new SuperMap.LevelRenderer.Tool.Curve();
    ...
    it("quadraticExtremum_divider_ToBe_Zero", function () {
        var p0 = 1, p1 = 1, p2 = 1;
        var init = new SuperMap.LevelRenderer.Tool.Curve();
        var result = init.quadraticExtremum(p0, p1, p2);
    ...
    it("quadraticProjectPoint", function () {
