...
describe("GeometryBatchAnalystService", () => {
    ...
    it('GeometryBatchAnalystService', (done) => {
        ...
        geometryBatchAnalystService.processAsync(geometryBatchAnalystParameters, analyzeCompleted);
    });

    it('GeometryBatchAnalystService promise', (done) => {
      var analyzeCompleted = (analystEventArgsSystem) => {
          try {
              var bfMode = analystEventArgsSystem.result;
              expect(bfMode).not.toBeNull();
      ...
      geometryBatchAnalystService.processAsync(geometryBatchAnalystParameters).then(analyzeCompleted);
  });
});