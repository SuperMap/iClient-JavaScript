...
var initRouteLocatorService = (url) => {
...
describe('RouteLocatorService', () => {
    ...
    it('processAsync_RouteLocatorPoint', (done) => {
        ...
        var routeLocatorService = initRouteLocatorService(spatialAnalystURL);
        ...
        routeLocatorService.processAsync(routeLocatorParameters_point, routeLocatorCompleted);
    });
    ...
    it('processAsync_RouteLocatorLine', (done) => {
        ...
        routeLocatorService.processAsync(routeLocatorParameters_line, routeLocatorCompleted);
    });

    it('processAsync_RouteLocatorLine promise', (done) => {
      var spatialAnalystURL = GlobeParameter.spatialAnalystURL;
      var routeLocatorCompleted = (routeLocatorEventArgs) => {
          routeLocatorEventArgsSystem = routeLocatorEventArgs;
          try {
      ...
      routeLocatorService.processAsync(routeLocatorParameters_line).then(routeLocatorCompleted);
  });
    ...
    it('processAsync_customQueryParam', (done) => {
        ...
        var routeLocatorService = initRouteLocatorService(spatialAnalystURL + '?key=123');
        spyOn(FetchRequest, 'post').and.callFake((url, params, options) => {
