...
describe('SetLayerInfoService', () => {
    ...
    it('setNewTempLayer', (done) => {
        ...
        setLayersInfoService.processAsync(layersInformation, setLayerInfoCompleted);
    });
    ...
    it('setLayerInfo', (done) => {
        if (id == null) {
            ...
            setLayerInfoService.processAsync(layerInformation, setLayerInfoCompleted);
        }
    });

    it('setLayerInfo promise', (done) => {
      if (id == null) {
          console.log("没有得到临时图层ID");
      } else {
          var layerInformation = layerInfo;
          ...
          setLayerInfoService.processAsync(layerInformation).then(setLayerInfoCompleted);
      }
  });
});