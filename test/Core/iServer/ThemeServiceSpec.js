require('../../../src/Core/iServer/ThemeService');
...
describe('testThemeService_processAsync', function () {
    ...
    it('Label__WithMemortData',function(done){
        ...
        themeMemoryData = new ThemeMemoryData(srcData, targetData);
        themeLabel = new ThemeLabel({
