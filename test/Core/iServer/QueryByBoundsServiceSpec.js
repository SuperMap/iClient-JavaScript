require('../../../src/Core/iServer/QueryByBoundsService');
...
function initQueryByBoundsService() {
    return new SuperMap.REST.QueryByBoundsService(worldMapURL);
}
var options = {
    eventListeners: {
...
function initQueryByBoundsService_RegisterListener() {
    return new SuperMap.REST.QueryByBoundsService(worldMapURL, options);
}
    ...
    it('pass',function(done){
        ...
        setTimeout(function() {
            try{
                ...
                expect(serviceCompletedEventArgsSystem.result[0].features.length).toEqual(15);
                queryByBoundsService.destroy();
                expect(queryByBoundsService.EVENT_TYPES).toBeNull();
                expect(queryByBoundsService.events).toBeNull();
                expect(queryByBoundsService.returnContent).toBeNull();
