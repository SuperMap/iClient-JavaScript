require('../../../src/mapboxgl/services/ThemeService');
...
describe('mapboxgl_ThemeService', function () {
    ...
    it('getThemeInfo_dotDensity', function (done) {
        ...
        var service = new mapboxgl.supermap.ThemeService(worldURL);
        var expectParams;
    ...
    it('getThemeInfo_GraduatedSymbol', function (done) {
        ...
        var service = new mapboxgl.supermap.ThemeService(chinaURL);
        var expectParams;
        spyOn(FetchRequest, 'commit').and.callFake(function (method, testUrl, params, options) {
            expect(method).toBe("POST");
    ...
    it('getThemeInfo_GridUnique', function (done) {
        ...
        var service = new mapboxgl.supermap.ThemeService(jingjingURL);
        var expectParams;
        spyOn(FetchRequest, 'commit').and.callFake(function (method, testUrl, params, options) {
            expect(method).toBe("POST");
