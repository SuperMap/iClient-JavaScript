import {ProcessingService} from '../../../src/maplibregl/services/ProcessingService';
...
describe('maplibregl_ProcessingService', () => {
    ...
    it('addKernelDensityJob, getKernelDensityJobState', (done) => {
        ...
        var kernelDensityJobParams = new KernelDensityJobParameter({
            ...
            fields: "",                //选填参数, 权重值字段
            query: new maplibregl.LngLatBounds(new maplibregl.LngLat(74.150, 40.550), new maplibregl.LngLat(-73.750, 40.950)), //选填参数,分析范围
    ...
    it('addSummaryMeshJob, getSummaryMeshJobState', (done) => {
        ...
        var summaryMeshJobParams = new SummaryMeshJobParameter({
            datasetName: "samples_newyork_taxi_2013-01_14k",  //必填参数, 源数据集
            query: new maplibregl.LngLatBounds(new maplibregl.LngLat(74.15, 40.55), new maplibregl.LngLat(-73.75, 40.95)), //选填参数,分析范围
            resolution: 100,              //网格大小
  ...
  //测试不设置query的情况
    ...
    it('addSummaryRegionJob, getSummaryRegionJobState', (done) => {
        ...
        var summaryRegionJobParams = new SummaryRegionJobParameter({
            ...
            query: new maplibregl.LngLatBounds(new maplibregl.LngLat(-74.05, 40.65), new maplibregl.LngLat(-73.85, 40.85)), //选填参数,分析范围
    ...
    it('addBuffersJob, getBuffersJobState', (done) => {
        ...
        var buffersJobParameter = new BuffersAnalystJobsParameter({
            ...
            bounds: new maplibregl.LngLatBounds(new maplibregl.LngLat(74.15, 40.55), new maplibregl.LngLat(-73.75, 40.95)), //选填参数,分析范围
            distance: "15",     //缓冲区半径
