...
describe('maplibregl_SpatialAnalystService_interpolationAnalysis', function () {
    var serviceResult;
    var originalTimeout;
    beforeEach(function () {
    ...
    it('interpolationAnalysis_density', function (done) {
        ...
        spyOn(FetchRequest, 'commit').and.callFake((method, testUrl, params, options) => {
            ...
            // var expectParams = "{'bounds':{'left':-2640403.63,'bottom':1873792.1, 'right':3247669.39,'top':5921501.4,'centerLonLat':null},'searchRadius':0,'zValueFieldName':\"AVG_TMP\",'zValueScale':1,'resolution':3000,'filterQueryParameter':null,'outputDatasetName':\"Interpolation_density_maplibreglTest\",'outputDatasourceName':\"Interpolation\", 'pixelFormat':\"DOUBLE\",'dataset':\"SamplesP@Interpolation\",'inputPoints':null,'InterpolationAnalystType':\"dataset\",'clipParam':null}";
