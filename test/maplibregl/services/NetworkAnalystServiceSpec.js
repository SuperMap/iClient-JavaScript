import { NetworkAnalystService } from '../../../src/maplibregl/services/NetworkAnalystService';
...
describe('maplibregl_NetworkAnalystService', () => {
    var serviceResult;
    var originalTimeout;
    beforeEach(() => {
    ...
    it('findPath', (done) => {
        ...
        var findPathParameters = new FindPathParameters({
            isAnalyzeById: false,
            nodes: [new maplibregl.Point(4000, -3000), new maplibregl.Point(5500, -2500), new maplibregl.Point(6900, -4000)],
    ...
    it('findTSPPaths', (done) => {
        ...
        var findTSPPathsParameters = new FindTSPPathsParameters({
            ...
            isAnalyzeById: false,
            //旅行商分析途经点数组，必设字段
            nodes: [new maplibregl.Point(3000, -1000), new maplibregl.Point(3760, -4850), new maplibregl.Point(8000, -2700)],
            parameter: analystParameter
        });
        var service = new NetworkAnalystService(url, options);
        spyOn(FetchRequest, 'commit').and.callFake((method, testUrl) => {
    ...
    it('findMTSPPaths', (done) => {
        var findMTSPPathsParameter = new FindMTSPPathsParameters({
            centers: [new maplibregl.Point(6000, -5500), new maplibregl.Point(5500, -2500), new maplibregl.Point(2500, -3500)],
            isAnalyzeById: false,
            nodes: [new maplibregl.Point(5000, -5000), new maplibregl.Point(6500, -3200)],
    ...
    it('findServiceAreas', (done) => {
        var point = new maplibregl.Point(5605, -3375);
        var resultSetting = new TransportationAnalystResultSetting({
            returnEdgeFeatures: true,
            returnEdgeGeometry: true,
            returnEdgeIDs: true,
    ...
    it('findClosestFacilities', (done) => {
        ...
        var findClosetFacilitiesParameter = new FindClosestFacilitiesParameters({
            //事件点,必设参数
            event: new maplibregl.Point(5000, -3700),
            //要查找的设施点数量。默认值为1
            expectFacilityCount: 1,
            //设施点集合,必设
            facilities: [new maplibregl.Point(2500, -3500), new maplibregl.Point(5500, -2500), new maplibregl.Point(7000, -4000)],
            isAnalyzeById: false,
            parameter: analystParameter
        });
        var service = new NetworkAnalystService(url, options);
