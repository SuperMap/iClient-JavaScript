...
describe('maplibregl_FeatureService_getFeaturesByBuffer', () => {
    ...
    it('getFeaturesByBuffer_geometry_maplibreglPoint', done => {
        var queryBufferGeometry = new maplibregl.Point(-77, 38);
        var bufferParam = new GetFeaturesByBufferParameters({
            datasetNames: ['World:Capitals'],
            bufferDistance: 10,
            geometry: queryBufferGeometry,
    ...
    it('getFeaturesByBuffer_geometry_maplibreglLatlng', done => {
        var queryBufferGeometry = new maplibregl.LngLat(-77, 38);
        var bufferParam = new GetFeaturesByBufferParameters({
            datasetNames: ['World:Capitals'],
            bufferDistance: 10,
            geometry: queryBufferGeometry,
