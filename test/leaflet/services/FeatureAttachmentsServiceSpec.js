import { featureAttachmentsService } from '../../../src/leaflet/services/FeatureAttachmentsService';
...
describe('openlayers_FeatureAttachmentsService', () => {
    ...
    it('initialize', () => {
        var faService = featureAttachmentsService(url);
        expect(faService.url).toEqual(url);
    });
    ...
    it('getAttachments', (done) => {
        ...
        featureAttachmentsService(url).featureAttachments(Params, (serviceResult) => {
            try {
