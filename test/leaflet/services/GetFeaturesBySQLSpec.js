...
describe('leaflet_FeatureService_getFeaturesBySQL', () => {
    ...
    //             new Response(
    //                 `{"postResultType":"CreateChild","newResourceID":"c01d29d8d41743adb673cd1cecda6ed0_aeeacd0b0b3e492b9bdab6fa92e91184","succeed":true,"newResourceLocation":"http://localhost:8090/iserver/services/data-world/rest/data/featureResults/c01d29d8d41743adb673cd1cecda6ed0_aeeacd0b0b3e492b9bdab6fa92e91184.json"}`
    //             )
    //         );
    //     });
    //     getFeaturesBySQLService.getFeaturesBySQL(getFeaturesBySQLParams, result => {
    ...
    //         } catch (exception) {
    //             console.log(
    //                 "leafletGetFeaturesBySQLService_'successEvent:returnContent=false'案例失败：" +
    //                     exception.name +
    //                     ':' +
    //                     exception.message
    //             );
    ...
    //         } catch (exception) {
    //             console.log(
    //                 "leafletGetFeaturesBySQLService_'failEvent:datasetNotExist'案例失败：" +
    //                     exception.name +
    //                     ':' +
    //                     exception.message
    //             );
    ...
    //         return Promise.resolve(
    //             new Response(
    //                 `{"succeed":false,"error":{"code":400,"errorMsg":"在FeatureResults资源中，检查请求体时，发现Queryparam为空。"}}`
    //             )
    //         );
    //     });
    //     getFeaturesBySQLService.getFeaturesBySQL(getFeaturesBySQLParams, result => {
    ...
    //         } catch (exception) {
    //             console.log(
    //                 "leaflet_getFeaturesBySQL_'failEvent:queryParameterNull'案例失败：" +
    //                     exception.name +
    //                     ':' +
    //                     exception.message
    //             );
    ...
    //     });
    // });
    // it('getFeaturesBySQLParams:targetEpsgCode', done => {
    //     var getFeaturesBySQLService = featureService(dataServiceURL, options);
    //     var getFeaturesBySQLParams = new GetFeaturesBySQLParameters({
    //         queryParameter: null,
    //         datasetNames: ['World:Countries'],
    ...
    //     });
    // });
    // it('getFeaturesBySQLParams:targetPrj', done => {
    //     var getFeaturesBySQLService = featureService(dataServiceURL, options);
    //     var getFeaturesBySQLParams = new GetFeaturesBySQLParameters({
    //         queryParameter: null,
    //         datasetNames: ['World:Countries'],
