...
describe('leaflet_clientcomputation_ClientComputationView', () => {
    ...
    it('clearLayer,cancelAnalysis', (done) => {
            try {
                ...
                var cancelBtn = document.getElementsByClassName('component-analysis__analysisbtn--cancel')[0];
                cancelBtn.click();
                expect(clientComputation.viewModel.cancelAnalysis).toHaveBeenCalled();
                var delBtn = document.getElementsByClassName('component-analysis__analysisbtn--deletelayers')[0];
                delBtn.click();
