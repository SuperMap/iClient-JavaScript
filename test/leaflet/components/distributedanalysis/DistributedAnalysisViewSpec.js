...
import { distributedAnalysisView } from '../../../../src/leaflet/components/distributedanalysis/DistributedAnalysisView';
...
describe('leaflet_distributedanalysis_DistributedAnalysisView', () => {
    ...
    it('analysis', (done) => {
        ...
        var weightFieldsSelectName = document.getElementsByClassName('component-selecttool__name');
        weightFieldsSelectName[3].innerHTML = "rate_code";
        weightFieldsSelectName[3].title = "rate_code";
        document.getElementsByClassName('component-content component-content--scroll component-content--analysis')[0].style="max-height: 880px;";
    ...
    it('getDatasetInfo', (done) => {
        ...
        // document.getElementsByClassName("component-selecttool__option")[0].click();
