import {ProcessingService} from '../../../src/classic/services/ProcessingService';
...
describe('classic_ProcessingService', () => {
    ...
    it('addKernelDensityJob, getKernelDensityJobState', (done) => {
        ...
        var kernelDensityJobParams = new KernelDensityJobParameter({
            ...
            fields: "",                //选填参数, 权重值字段
            query: new Bounds([-74.15, 40.55, -73.75, 40.95]), //选填参数,分析范围,左下右上
    ...
    it('addBuffersJob, getBuffersJobState', (done) => {
        ...
        var buffersJobParameter = new BuffersAnalystJobsParameter({
            ...
            bounds: new Bounds([-74.15, 40.55, -73.75, 40.95]), //选填参数,分析范围,左下右上
            distance: "15",     //缓冲区半径
