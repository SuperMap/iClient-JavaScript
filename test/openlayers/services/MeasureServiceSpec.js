...
describe('openlayers_MeasureService', () => {
    ...
    it('success:measureDistance', (done) => {
        ...
        spyOn(FetchRequest, 'commit').and.callFake((method,testUrl) => {
            ...
            expect(testUrl).toBe("http://localhost:9876/iserver/services/map-world/rest/maps/World/distance");
    ...
    it('success:measureArea', (done) => {
        ...
        spyOn(FetchRequest, 'commit').and.callFake((method,testUrl) => {
            expect(method).toBe("GET");
            expect(testUrl).toBe("http://localhost:9876/iserver/services/map-world/rest/maps/World/area");
