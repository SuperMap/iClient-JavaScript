import { WebPrintingJobService } from '../../../src/openlayers/services/WebPrintingJobService';
...
import { WebPrintingJobNorthArrowOptions } from '../../../src/common/iServer/WebPrintingJobNorthArrowOptions';
import { WebPrintingJobLittleMapOptions } from '../../../src/common/iServer/WebPrintingJobLittleMapOptions';
import { WebPrintingJobImage } from '../../../src/common/iServer/WebPrintingJobImage';
import { WebPrintingJobLegendOptions } from '../../../src/common/iServer/WebPrintingJobLegendOptions';
import { WebPrintingJobCustomItems } from '../../../src/common/iServer/WebPrintingJobCustomItems';
...
describe('openlayers_WebPrintingJobService', () => {
    var serviceResult;
    var originalTimeout;
    beforeEach(() => {
    ...
    it('createWebPrintingJob', (done) => {
        var param = new WebPrintingJobParameters({
            ...
            layoutOptions: new WebPrintingJobLayoutOptions({
                ...
                northArrowOptions: new WebPrintingJobNorthArrowOptions({
                    picAsUrl: 'http://test.com/test.png'
                }),
                littleMapOptions: new WebPrintingJobLittleMapOptions({
                    scale: '0.00012099529215826183',
                    center: [12123228.72886939, 2731834.3979613623],
                    image: new WebPrintingJobImage({
                        picAsBase64:
                ...
                legendOptions: new WebPrintingJobLegendOptions({
                    customItems: new WebPrintingJobCustomItems({
                        picAsBase64:
                            'data:image/png;base64,',
                        name: '图例1'
                    })
        ...
        webPrintingJobService.createWebPrintingJob(param, (result) => {
            ...
            try {
                expect(webPrintingJobService).not.toBeNull();
    ...
    it('getPrintingJob', (done) => {
        ...
        webPrintingJobService.getPrintingJob(jobId, (result) => {
            serviceResult = result;
            try {
                expect(serviceResult).not.toBeNull();
    ...
    // 获取 Web 打印下载打印内容
    it('getPrintingJobResult', (done) => {
        var webPrintingJobService = new WebPrintingJobService(url);
        var jobId = 'e3ff26fa-a0b5-46d3-ad4a-096611a59c03@9fd5defe-d77d-4e17-967e-643c4f34d67e';
        spyOn(FetchRequest, 'commit').and.callFake((method, testUrl) => {
            expect(method).toBe('GET');
            expect(testUrl).toBe(url + `/jobs/${jobId}/result`);
            return Promise.resolve(new Response(new Blob()));
        });
        webPrintingJobService.getPrintingJobResult(jobId, (result) => {
            serviceResult = result;
            try {
                expect(serviceResult).not.toBeNull();
                done();
            } catch (e) {
                console.log("'getPrintingJobResult'案例失败" + e.name + ':' + e.message);
                expect(false).toBeTruthy();
                done();
            }
        });
    ...
    it('getLayoutTemplates', (done) => {
        ...
        webPrintingJobService.getLayoutTemplates((result) => {
            serviceResult = result;
            try {
                expect(webPrintingJobService).not.toBeNull();
                expect(serviceResult).not.toBeNull();
    ...
    it('createWebPrintingJob_SummaryTextAndTime_emptyString', (done) => {
      var param = new WebPrintingJobParameters({
        content: new WebPrintingJobContent({
          type: 'WEBMAP',
          url: 'https://www.supermapol.com/web/maps/1887887232/map.json'
      ...
      spyOn(FetchRequest, 'commit').and.callFake((method, testUrl, params, options) => {
        if (testUrl === url + '/jobs') {
          ...
          expect(paramsObj.layoutOptions.time).toBe('');
          expect(paramsObj.layoutOptions.summaryText).toBe('');
          return Promise.resolve(new Response(JSON.stringify(createWebPringintJobResultJson)));
        }
        return Promise.resolve(new Response(JSON.stringify(getLayoutsResultJson)));
      });
      webPrintingJobService.createWebPrintingJob(param, (result) => {
        ...
        try {
          ...
          console.log("'createWebPrintingJob_SummaryTextAndTime_emptyString'案例失败" + e.name + ':' + e.message);
          expect(false).toBeTruthy();
          done();
        }
      });
