...
module.exports = {
    'leaflet_02_getFeatureByBuffer': function (browser) {
        ...
        browser.expect.element('.leaflet-pane.leaflet-popup-pane').to.be.present.before(3000);
        ...
        browser.expect.element('//*[@id="map"]/div[1]/div[6]/div/div[1]/div').to.be.present.before(3000);
        var featureInfo = '首都';
